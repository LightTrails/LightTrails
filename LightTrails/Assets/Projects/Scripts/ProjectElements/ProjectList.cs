...
public class ProjectList : MonoBehaviour
{
    ...
    public void Reload()
    {
        ...
        foreach (var item in GetComponentsInChildren<ProjectOptionItem>())
        {
    ...
    public void CreateProjectItem(Project project)
    {
        var newObject = Instantiate(Prefab);
        newObject.transform.SetParent(gameObject.transform);
        newObject.GetComponent<ProjectOptionItem>().SetProject(project);
    }
}
